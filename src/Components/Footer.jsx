...
const Footer = () => {
    return (
        <footer className="container mx-auto footer footer-center p-10 bg-secondary-focus text-primary-content">
            <div>
                ...
                <p className="font-bold">
                    La Cuisine. <br />Providing reliable service since 2000
                </p>
