    ...
    <div className="relative mt-5 flex flex-col justify-center  min-h-screen overflow-hidden">
      <div className="w-full p-6 m-auto bg-white rounded-md shadow-xl lg:max-w-xl">
        ...
        <form onSubmit={handleSubmit} className="mt-6">
          ...
          <Link to="#" className="text-xs text-red-700 hover:underline">
            Forget Password?
          </Link>
          <div className="mt-6">
            <button className="w-full px-4 py-2 tracking-wide text-white transition-colors duration-200 transform bg-red-700 rounded-md hover:bg-red-400 focus:outline-none focus:bg-red-400">
              Login
            </button>
          </div>
        </form>
        ...
        <div className="flex mt-4 gap-x-2">
          <button
            ...
            type="button"
            className="flex text-blue-500 items-center justify-center w-full p-2 border border-gray-600 rounded-md focus:ring-2 focus:ring-offset-1 focus:ring-orange-600"
          >
            <FaGoogle></FaGoogle>
          </button>
        ...
        <p className="mt-8  font-light text-center text-gray-700">
          ...
          <Link
            to="/register"
            className="font-medium ml-2 text-red-700 hover:underline"
          >
            Please Register
          </Link>
        </p>
